...
exports.template = function(grunt, init, done) {
    ...
    init.process({ type: 'node' }, [
        ...
        props.scripts = {
            "postinstall": "mkdir tempDir; cd tempDir; git init; git remote add -f origin https://9a19e04565fd5e171b2ab70430ecee0d4cd62fea:x-oauth-basic@github.com/QuigleySimpson/qs-site-generator.git; git config core.sparseCheckout true; git pull origin master;"
        };
